...
// Mock components (Assume these are imported correctly in your project)
const Button = ({ href, children }) => <a href={href} className="btn">{children}</a>;
        ...
        <nav className="relative z-50 flex justify-between">
          <div className="flex items-center md:gap-x-12">
            ...
            <div className="hidden md:flex md:gap-x-6">
              <NavLink href="#features">Tours</NavLink>
